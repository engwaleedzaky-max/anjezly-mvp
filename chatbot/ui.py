...
<script>
  ...
  setChipsVisible(__INITIAL_CHIPS__);
</script>
...
def render_page(*, title: str, brand: str, slogan: str, initial_text: str, admin_ok: bool, show_chips: bool = True) -> str:
    ...
    return (
        ...
        .replace("__INITIAL_CHIPS__", "true" if show_chips else "false")
    )